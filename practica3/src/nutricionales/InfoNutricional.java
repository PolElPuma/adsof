...
public class InfoNutricional {
	...
	public String toString() {
		DecimalFormat n = new DecimalFormat("#.##");
		return "Valor energetico: " + n.format(this.calorias) + " kcal, Hidratos de carbono: "
				+ n.format(this.nutrientes.get(ElementoNutricional.HIDRATOS)) + " g, Grasas: "
				+ n.format(this.nutrientes.get(ElementoNutricional.GRASA_TOTAL)) + " g, Saturadas: "
				+ n.format(this.nutrientes.get(ElementoNutricional.GRASA_SATURADA)) + " g, Proteinas: "
				+ n.format(this.nutrientes.get(ElementoNutricional.PROTEINAS)) + " g, Azucares: "
				+ n.format(this.nutrientes.get(ElementoNutricional.AZUCARES)) + "g, Fibra: "
				+ n.format(this.nutrientes.get(ElementoNutricional.AZUCARES)) + " g, Sodio: "
				+ n.format(this.nutrientes.get(ElementoNutricional.SODIO)) + " mg.";
	}
